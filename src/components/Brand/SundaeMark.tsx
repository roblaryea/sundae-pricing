 ...
 * cut into an S, topped by the cherry (the signal). Ported verbatim from the
 * marketing site (src/components/ui/SundaeMark.tsx) so pricing, marketing, and
 * app all render one identical mark.
 *
